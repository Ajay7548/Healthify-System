...
// Admin-only CSV ingestion + the audit log of past imports. Mounted under /admin.
export const adminUploadsRouter = Router();
adminUploadsRouter.use(authenticate, requireRole('ADMIN'));

adminUploadsRouter.post('/reports/upload', uploadCsv, uploadController.uploadReports);
