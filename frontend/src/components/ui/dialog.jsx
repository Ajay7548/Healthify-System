  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          'fixed left-1/2 top-1/2 z-50 max-h-[85vh] w-[calc(100%-2rem)] max-w-lg -translate-x-1/2',
          '-translate-y-1/2 overflow-y-auto rounded-xl border border-border bg-surface p-6 shadow-lg',
          className,
        )}
        {...props}
      >
